...
declare module '$env/static/private' {
	...
	export const PYPI_SPECTRUM_3RD_USER: string;
	export const PATH: string;
	export const KUBECTL_KPI_LAB: string;
	...
	export const PYPI_SPECTRUM_3RD_PASSWORD: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_execpath: string;
		PYPI_SPECTRUM_3RD_USER: string;
		PATH: string;
		KUBECTL_KPI_LAB: string;
		...
		PYPI_SPECTRUM_3RD_PASSWORD: string;
